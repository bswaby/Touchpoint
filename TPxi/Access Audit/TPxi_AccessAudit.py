...
# ===========================================================================
# Generated data. Everything above this line is code.
#
# This holds ONLY what TouchPoint's own code checks. Anything specific to this
# church, which involvements a role restricts, which content and reports it
# gates, is read live by role_db_usage() instead. Baking those in as well was
# double counting them: FMC showed 89 involvements against a real 49.
#
# role -> area -> [kind, identifier, readable label], produced by
# _rolemap/scan_source.py reading TouchPoint's C# source: the [Authorize] and
# [FunctionAuthorize] attributes, User.IsInRole in the views, and the Can*
# methods on PermissionsService. It is reference data about TouchPoint itself,
# not about this church, so it only changes when TouchPoint ships a release.
#
# Roughly four fifths of TouchPoint's permission logic is role based and is in
# here. The rest is relational, whether you lead a given involvement, are in
# the same family, or are the person being viewed, and cannot be read off a
# role name at all. Those are marked "also relational" where they appear.
#
# To refresh: python3 _rolemap/scan_source.py, then paste the new json here or
# into Special Content named TPxi_AccessAudit_RoleMap, which wins over this.
# ===========================================================================

# The roles TouchPoint itself ships, lifted from Tps.Core/Roles.cs. Anything in
# the Roles table that is not in this list was created in this database by
# somebody at this church, which is worth knowing: TouchPoint's own code never
# checks a custom role, so it only does whatever it was wired into here.
# TouchPoint's own 60 screen settings, lifted from
# CmsWeb/Views/Shared/RoleSettingDefaults.xml. Keys: n name, g group,
# f friendly label, t tooltip, y/no the on and off labels, d the default,
# r reverse (the toggle shows the opposite of the stored value, which is how
# a setting called DisablePersonLinks can read "Enable" when it is false).
...
ROLE_MAP_JSON = """{"Access":{"ESignature (API)":[["API endpoint","v1/ESignature/ConfigureWebhook","Configure webhook (e signature)"],["API endpoint","v1/ESignature/GetDocument/{requestId:int}","Document (e signature), for a given request"],["API endpoint","v1/ESignature/GetUnfilledSignatureRequests/{orgId:int}","Unfilled signature requests (e signature), for a given org"],["API endpoint","v1/ESignature/SyncSignatureTemplates","Sync signature templates (e signature)"]],"Giving":[["page or action","GivingManagementController.GetOnlineNotifyPersonList","Online notify person list"]],"Main":[["screen element","Index.cshtml","Email"]],"People":[["screen element","Current.cshtml","Person, Enrollment, Current"],["screen element","Documents.cshtml","Person, Profile, Membership, Documents"],["screen element","Emails.cshtml","Person, Communications, Emails"],["screen element","Index.cshtml","Person, Touchpoints"],["screen element","Members.cshtml","Person, Family, Members"],["screen element","Pending.cshtml","Person, Enrollment, Pending"],["screen element","Previous.cshtml","Person, Enrollment, Previous"],["screen element","Related.cshtml","Person, Family, Related"],["screen element","Tab.cshtml","Person, Profile"],["screen element","TaskNoteIndex.cshtml","Touchpoints, Task note index"]],"Permission checks":[["capability","CanAccessTaskNotes","Access task notes"],["capability (also relational)","CanAddPersonTaskNotes","Add person task notes"],["capability (also relational)","CanCheckInFamily","Check in family"],["capability","CanCreateUserToken","Create user token"],["capability","CanManageEmailQueue","Manage email queue"],["capability","CanManageMobileBanners","Manage mobile banners"],["capability (also relational)","CanViewDirectoryPersonProfile","View directory person profile"],["capability (also relational)","CanViewPerson","View person"],["capability (also relational)","CanViewPersonBadges","View person badges"],["capability (also relational)","CanViewPersonChannels","View person channels"],["capability (also relational)","CanViewPersonEmergencyContact","View person emergency contact"],["capability (also relational)","CanViewPersonEngagementScore","View person engagement score"],["capability (also relational)","CanViewPersonInvolvements","View person involvements"],["capability (also relational)","CanViewPersonPrayerRequests","View person prayer requests"],["capability (also relational)","CanViewPersonTaskNotes","View person task notes"]],"Public":[["page or action","APICheckin2Controller.CheckIn","Check in"]],"Rainforest (API)":[["API endpoint","v1/Rainforest/ConfirmPayin","Confirm payin (rainforest)"],["API endpoint","v1/Rainforest/Payin/{payinId}","Payin (rainforest), for a given payin"],["API endpoint","v1/Rainforest/PaymentMethodConfig","Payment method config (rainforest)"]],"Registrations (API)":[["API endpoint","v1/Involvements/{orgId:int}/Members/{peopleId}/TransactionSummary","Transaction summary (involvements members), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/Settings","Settings (involvements registrations), for a given org"],["API endpoint","v1/Involvements/{orgId:int}/TransactionSummary","Transaction summary (involvements), for a given org"]],"Web":[["screen element","CustomHeader.cshtml","Shared, Custom header"],["screen element","NavBar.cshtml","Shared, Nav bar"],["screen element","SearchBox.cshtml","Shared, Search box"]],"Your scripts":[["referenced in script","BGAndTrainingStatus.py","BG and training status"],["referenced in script","BlueToolbarReport.py","Blue toolbar report"],["referenced in script","EmergencyListEnhanced.py","Emergency list enhanced"],["referenced in script","EnhancedSchedulerReport.py","Enhanced scheduler report"],["referenced in script","TPxi_ReportBuilderBlueToolbar.py","Report builder blue toolbar"],["referenced in script","TPxi_ReportBuilderDirect.py","Report builder direct"]]},"AccountManager":{"Permission checks":[["capability","CanManageOrViewLimitedAccountCodes","Manage or view limited account codes"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Admin":{"CheckIn":[["page or action","CheckInDashboardController.CheckInDashboard","Check in dashboard"],["page or action","CheckinLabelsController","Checkin labels controller"],["page or action","ClassroomDashboardController.Index","Index classroom dashboard"],["page or action","ClassroomDashboardController.Person","Person classroom dashboard"],["page or action","FieldRequirementController","Field requirement controller"],["page or action","LabelEditorController","Label editor controller"],["page or action","WebCheckinLabelsController","Web checkin labels controller"]],"ContentSafety (API)":[["API endpoint","v1/ContentSafety/CheckImageContent","Check image content (content safety)"],["API endpoint","v1/ContentSafety/CheckTextContent","Check text content (content safety)"]],"Dialog":[["page or action","OrgMemberDialogController.SmallGroupChecked","Small group checked"]],"ESignature (API)":[["API endpoint","v1/ESignature/ConfigureWebhook","Configure webhook (e signature)"],["API endpoint","v1/ESignature/GetDocument/{requestId:int}","Document (e signature), for a given request"],["API endpoint","v1/ESignature/GetUnfilledSignatureRequests/{orgId:int}","Unfilled signature requests (e signature), for a given org"],["API endpoint","v1/ESignature/SyncSignatureTemplates","Sync signature templates (e signature)"]],"Finance":[["page or action","FundController","Fund controller"],["page or action","FundController.Index","Index fund"],["page or action","FundSetsController","Fund sets controller"]],"Giving":[["page or action","GivingManagementController.CheckUrlAvailability","Check URL availability"],["page or action","GivingManagementController.Create","Create giving management"],["page or action","GivingManagementController.Delete","Delete giving management"],["page or action","GivingManagementController.GetAvailableFunds","Available funds"],["page or action","GivingManagementController.GetCampusList","Campus list"],["page or action","GivingManagementController.GetConfirmationEmailList","Confirmation email list"],["page or action","GivingManagementController.GetEntryPoints","Entry points"],["page or action","GivingManagementController.GetOnlineNotifyPersonList","Online notify person list"],["page or action","GivingManagementController.GetShellList","Shell list"],["page or action","GivingManagementController.Index","Index giving management"],["page or action","GivingManagementController.List","List giving management"],["page or action","GivingManagementController.Manage","Manage giving management"],["page or action","GivingManagementController.New","New giving management"],["page or action","GivingManagementController.SaveGivingPageEnabled","Save giving page enabled"],["page or action","GivingManagementController.SetGivingDefaultPage","Set giving default page"],["page or action","GivingManagementController.Update","Update giving management"]],"Involvements (API)":[["API endpoint","v1/Involvements","Involvements"],["API endpoint","v1/Involvements/Divisions/Search","Search (involvements divisions)"]],"Main":[["screen element","Announcement.cshtml","Announcement, Announcement"],["page or action","TagsController.ConvertTagToExtraValue","Convert tag to extra value"]],"Manage":[["page or action","BatchMoveAndDeleteController.MoveAndDelete","Move and delete"],["page or action","DuplicatesController","Duplicates controller"],["page or action","EmailTemplatesController","Email templates controller"],["page or action","ExtraValuesController.DeleteAll","Delete all"],["page or action","InvolvementController","Involvement controller"],["page or action","McpController","Mcp controller"],["page or action","MediaController.CreateResource","Create resource"],["page or action","MediaController.CreateResourceCategory","Create resource category"],["page or action","MediaController.CreateResourceType","Create resource type"],["page or action","MediaController.DeleteAttachment","Delete attachment"],["page or action","MediaController.DeleteResource","Delete resource"],["page or action","MediaController.EditResource","Edit resource"],["page or action","MediaController.MoveResource","Move resource"],["page or action","MediaController.MoveResourceCategoryList","Move resource category list"],["page or action","MediaController.SaveAttachmentListOrder","Save attachment list order"],["page or action","MediaController.SaveResourceListOrder","Save resource list order"],["page or action","MediaController.UpdateAttachment","Update attachment"],["page or action","MediaController.UploadAttachment","Upload attachment"],["page or action","MergeController","Merge controller"],["page or action","ResourceController","Resource controller"],["page or action","UsersController","Users controller"]],"MeetingCategory":[["page or action","MeetingCategoryController.Edit","Edit meeting category"]],"Meetings (API)":[["API endpoint","v1/Involvements/{orgId:int}/Meetings","Meetings (involvements), for a given org"]],"People":[["screen element","MessagesNotificationsLog.cshtml","Person, Communications, Messages notifications log"]],"People (API)":[["API endpoint","v1/People/Search/AutocompleteEx/Registration","Registration (people search autocomplete ex)"]],"Permission checks":[["capability","CanApproveMeetings","Approve meetings"],["capability","CanApproveReservable","Approve reservable"],["capability","CanChangeTranslations","Change translations"],["capability (also relational)","CanCheckInFamily","Check in family"],["capability","CanCreateIntegrationContacts","Create integration contacts"],["capability","CanCreateIntegrationNotes","Create integration notes"],["capability (also relational)","CanEditPersonCampus","Edit person campus"],["capability","CanEditPersonDirectoryPrivacy","Edit person directory privacy"],["capability","CanEditPersonProfile","Edit person profile"],["capability","CanEditRegistrationSettings","Edit registration settings"],["capability","CanManageAllUserTokens","Manage all user tokens"],["capability","CanManageEmailQueue","Manage email queue"],["capability","CanManageNonContributions","Manage non contributions"],["capability","CanManageSystemNotifications","Manage system notifications"],["capability (also relational)","CanManageUserNotifications","Manage user notifications"],["capability","CanMergePeopleRecords","Merge people records"],["capability","CanRetrieveSpecialContent","Retrieve special content"],["capability","CanSendPushNotification","Send push notification"],["capability","CanStopOrDeleteNotification","Stop or delete notification"],["capability (also relational)","CanViewDirectoryPersonProfile","View directory person profile"]],"Rainforest (API)":[["API endpoint","v1/Rainforest/AddMerchant","Add merchant (rainforest)"],["API endpoint","v1/Rainforest/AdminSettings","Admin settings (rainforest)"],["API endpoint","v1/Rainforest/CreateMerchant","Create merchant (rainforest)"],["API endpoint","v1/Rainforest/DepositReportSession","Deposit report session (rainforest)"],["API endpoint","v1/Rainforest/MerchantOnboardingSession","Merchant onboarding session (rainforest)"],["API endpoint","v1/Rainforest/Merchants","Merchants (rainforest)"],["API endpoint","v1/Rainforest/OnboardingMerchants","Onboarding merchants (rainforest)"],["API endpoint","v1/Rainforest/PayinDetailsSession","Payin details session (rainforest)"]],"Registrations (API)":[["API endpoint","v1/Involvements/{orgId:int}/Members/{peopleId}/TransactionSummary","Transaction summary (involvements members), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/Settings","Settings (involvements registrations), for a given org"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/Settings/Settings","Settings (involvements registrations settings), for a given org"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/{peopleId:int}/Form","Form (involvements registrations), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/{peopleId:int}/Forms","Forms (involvements registrations), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/{regId:guid}/Form","Form (involvements registrations), for a given org and reg"],["API endpoint","v1/Involvements/{orgId:int}/TransactionSummary","Transaction summary (involvements), for a given org"]],"Reports":[["page or action","ReportsController.AddReport","Add report"],["page or action","ReportsController.Application","Application reports"],["page or action","ReportsController.DeleteCustomReport","Delete custom report"],["page or action","ReportsController.EditCustomReport","Edit custom report"],["page or action","ReportsController.RegistrationSummary","Registration summary"]],"Setup":[["page or action","BibleBookController","Bible book controller"],["page or action","DashboardWidgetController.Delete","Delete dashboard widget"],["page or action","DashboardWidgetController.Index","Index dashboard widget"],["page or action","DashboardWidgetController.Manage","Manage dashboard widget"],["page or action","DashboardWidgetController.Reorder","Reorder dashboard widget"],["page or action","DashboardWidgetController.Toggle","Toggle dashboard widget"],["page or action","DashboardWidgetController.Update","Update dashboard widget"],["page or action","DivisionController.Index","Index division"],["page or action","EmailDelegationController","Email delegation controller"],["page or action","KeywordExtraValuesController","Keyword extra values controller"],["page or action","KeywordsController","Keywords controller"],["page or action","LookupController","Lookup controller"],["page or action","MemberTypeController","Member type controller"],["page or action","MetroZipController","Metro zip controller"],["page or action","MinistryController","Ministry controller"],["page or action","ProgramController","Program controller"],["page or action","PromotionController","Promotion controller"],["page or action","RecurrenceRuleController.Index","Index recurrence rule"],["page or action","ResourceCategoryController","Resource category controller"],["page or action","ResourceMediaTypeController","Resource media type controller"],["page or action","ResourceTypeController","Resource type controller"],["page or action","RolesController","Roles controller"],["page or action","SettingController","Setting controller"],["page or action","TitleCodeController","Title code controller"],["page or action","TranslationsController.GetLanguages","Languages"],["page or action","TranslationsController.GetTranslations","Translations"],["page or action","TranslationsController.Index","Index translations"],["page or action","TranslationsController.RevertToDefault","Revert to default"],["page or action","TranslationsController.UpdateTranslation","Update translation"]],"Web":[["page or action","HomeController.ActiveRecords","Active records"]],"Your scripts":[["referenced in script","BlueToolBarCompliance.py","Blue tool bar compliance"],["referenced in script","FMC_MemberManager.py","Member manager"],["referenced in script","Missions Dashboard.py","Missions dashboard"],["referenced in script","ReportBuilderToolbar.py","Report builder toolbar"],["referenced in script","TPxi_AccountSecurityMonitor.py","Account security monitor"],["referenced in script","TPxi_LMSCurriculum.py","LMS curriculum"]]},"ApiOnly":{"Permission checks":[["capability","CanRetrieveDataWarehouseList","Retrieve data warehouse list"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_AccountSecurityMonitor.py","Account security monitor"]]},"AppAdmin":{"People":[["screen element","Tab.cshtml","Person, Communications"]],"Permission checks":[["capability","CanAddOrganizationPosts","Add organization posts"],["capability (also relational)","CanArchivePrayerRequest","Archive prayer request"],["capability (also relational)","CanChangePostCommentStatus","Change post comment status"],["capability (also relational)","CanChangeUserPostStatus","Change user post status"],["capability","CanDeleteOrganizationPosts","Delete organization posts"],["capability (also relational)","CanDeletePrayerRequest","Delete prayer request"],["capability","CanDeleteUserPosts","Delete user posts"],["capability","CanEditOrganizationPosts","Edit organization posts"],["capability (also relational)","CanModifyPrayerRequestAnswered","Modify prayer request answered"]],"Setup":[["page or action","SettingController","Setting controller"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Attendance":{"Org":[["screen element","Attendance.cshtml","Meeting, Attendance"],["screen element","Email.cshtml","Org search, Toolbar, Email"],["screen element","Index.cshtml","Meeting"],["page or action","MeetingController.CreateMeeting","Create meeting"],["page or action","MeetingController.MarkAttendance","Mark attendance"],["page or action","MeetingController.MarkRegistered","Mark registered"],["page or action","MeetingController.ScanTicket","Scan ticket"],["screen element","MeetingRightSideBar.cshtml","Meeting, Meeting right side bar"],["screen element","Meetings.cshtml","Org, Meetings"],["page or action","OrgSearchController.DisplayAttendanceNotices","Display attendance notices"],["page or action","OrgSearchController.EmailAttendanceNotices","Email attendance notices"],["screen element","iPad.cshtml","Meeting, I pad"]],"Permission checks":[["capability (also relational)","CanTakeAttendance","Take attendance"],["capability (also relational)","CanTakeMeetingAttendance","Take meeting attendance"],["capability (also relational)","CanTakeOrganizationAttendance","Take organization attendance"]],"Your scripts":[["referenced in script","DivisionAttendance.py","Division attendance"],["referenced in script","TPxi_GivingDashboard.py","Giving dashboard"],["referenced in script","TPxi_GivingDashboard_backup.py","Giving dashboard backup"],["referenced in script","TPxi_GivingDashboard_before_fix.py","Giving dashboard before fix"],["referenced in script","TPxi_GivingDashboard_broken.py","Giving dashboard broken"],["referenced in script","TPxi_GivingDashboard_broken2.py","Giving dashboard broken2"]]},"BackgroundCheck":{"People":[["screen element","Index.cshtml","Volunteering"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_ComplianceDashboard.py","Compliance dashboard"],["referenced in script","TPxi_PCOSync.py","PCO sync"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"],["referenced in script","dashboard_phase1_backup.py","Dashboard phase1 backup"]]},"BackgroundCheckRun":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"Beta":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"CalendarManagement":{"Permission checks":[["capability","CanApproveMeetings","Approve meetings"],["capability","CanApproveReservable","Approve reservable"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Checkin":{"CheckIn":[["page or action","CheckInDashboardController.CheckInDashboard","Check in dashboard"],["page or action","CheckinSetupController","Checkin setup controller"],["page or action","ClassroomDashboardController.Index","Index classroom dashboard"],["page or action","ClassroomDashboardController.Person","Person classroom dashboard"]],"Involvements (API)":[["API endpoint","v1/Involvements","Involvements"],["API endpoint","v1/Involvements/Divisions/Search","Search (involvements divisions)"]],"Meetings (API)":[["API endpoint","v1/Involvements/{orgId:int}/Meetings","Meetings (involvements), for a given org"]],"Web":[["screen element","Organization.cshtml","Shared, Menu, Organization"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_Dashboards.py","Dashboards"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_PhoneDirectory.py","Phone directory"],["referenced in script","TPxi_TPGo.py","TP go"]]},"Checkout":{"CheckIn":[["screen element","Index.cshtml","Classroom dashboard"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"ComplianceSpecializedViewOnly":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_ComplianceDashboard.py","Compliance dashboard"],["referenced in script","dashboard_phase1_backup.py","Dashboard phase1 backup"]]},"Coupon":{"Main":[["page or action","CouponController","Coupon controller"]],"Web":[["screen element","Organization.cshtml","Shared, Menu, Organization"]],"Your scripts":[["referenced in script","EnterpriseReporting.py","Enterprise reporting"],["referenced in script","MM-Transaction.py","MM transaction"],["referenced in script","PM_TransactionHistory.py","Transaction history"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_PaymentManagerV2.py","Payment manager v 2"]]},"Coupon2":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"]]},"CreditCheck":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"]]},"Delete":{"Org":[["page or action","OrgController.Delete","Delete org"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_AttendanceMarkings.py","Attendance markings"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"],["referenced in script","TPxi_VolunteerRecruiter.py","Volunteer recruiter"],["referenced in script","TPxi_pipeBuilder.py","Pipe builder"]]},"Design":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"]]},"Developer":{"ContentSafety (API)":[["API endpoint","v1/ContentSafety/CheckImageContent","Check image content (content safety)"],["API endpoint","v1/ContentSafety/CheckTextContent","Check text content (content safety)"]],"Dialog":[["screen element","Edit.cshtml","Org member dialog, Edit"],["page or action","OrgMemberDialogController.DeleteQuestion","Delete question"]],"Finance":[["screen element","Index.cshtml","Bundle"]],"Main":[["screen element","Announcement.cshtml","Announcement, Announcement"]],"Manage":[["screen element","Index.cshtml","Upload people"],["screen element","List.cshtml","Transactions, List"],["page or action","TransactionsController.AssignGoer","Assign goer"],["page or action","UploadExcelIpsController","Upload excel ips controller"],["page or action","UploadPeopleController","Upload people controller"]],"Org":[["screen element","Reports.cshtml","Org search, Toolbar, Reports"],["screen element","Tabs.cshtml","Org search, Tabs"]],"People":[["screen element","GearStandard.cshtml","Person, Toolbar, Gear standard"]],"Permission checks":[["capability","CanRetrieveDataWarehouseList","Retrieve data warehouse list"],["capability","CanSeeTestTransactions","See test transactions"]],"Search":[["page or action","ContactSearchController.DeleteContactsForType","Delete contacts for type"]],"Setup":[["screen element","Index.cshtml","Setting"],["screen element","_Settings.cshtml","Setting, Settings"],["screen element","_SettingsSearchResults.cshtml","Setting, Settings search results"],["screen element","_SettingsTabs.cshtml","Setting, Settings tabs"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_AccountSecurityMonitor.py","Account security monitor"],["referenced in script","TPxi_LMSAdmin.py","LMS admin"],["referenced in script","TPxi_LMSAdminSimple.py","LMS admin simple"],["referenced in script","TPxi_LMSDashboard.py","LMS dashboard"],["referenced in script","TPxi_MenuEditor.py","Menu editor"]]},"Edit":{"Dialog":[["page or action","AddOrganizationController","Add organization controller"]],"ESignature (API)":[["API endpoint","v1/ESignature/ConfigureWebhook","Configure webhook (e signature)"]],"Giving":[["page or action","GivingManagementController.GetOnlineNotifyPersonList","Online notify person list"]],"Involvements (API)":[["API endpoint","v1/Involvements","Involvements"],["API endpoint","v1/Involvements/Divisions/Search","Search (involvements divisions)"]],"Main":[["screen element","Announcement.cshtml","Announcement, Announcement"],["screen element","Compose.cshtml","Email, Compose"],["screen element","Index.cshtml","Email"],["screen element","Options.cshtml","SMS, Options"]],"Manage":[["screen element","ManageArea.cshtml","Volunteers, Manage area"],["page or action","TransactionsController","Transactions controller"]],"MeetingCategory":[["page or action","MeetingCategoryController.Edit","Edit meeting category"]],"Meetings (API)":[["API endpoint","v1/Involvements/{orgId:int}/Meetings","Meetings (involvements), for a given org"]],"Org":[["screen element","Attendance.cshtml","Org, Settings, Attendance"],["screen element","CheckIn.cshtml","Org, Settings, Check in"],["screen element","ExtrasGrid.cshtml","Org, Settings, Extras grid"],["screen element","Index.cshtml","Org"],["screen element","InlineCode.cshtml","Org, Display templates, Inline code"],["screen element","MeetingDetails.cshtml","Meeting, Meeting details"],["screen element","MeetingRightSideBar.cshtml","Meeting, Meeting right side bar"],["screen element","Messages.cshtml","Org, Registration, Messages"],["page or action","OrgController.CopySettings","Copy settings"],["page or action","OrgController.DeleteExtra","Delete extra"],["page or action","OrgController.EditExtra","Edit extra"],["page or action","OrgController.FeesEdit","Fees edit"],["page or action","OrgController.MessagesEdit","Messages edit"],["page or action","OrgController.MobileSettingsEdit","Mobile settings edit"],["page or action","OrgController.NewExtraValue","New extra value"],["page or action","OrgController.QuestionsEdit","Questions edit"],["page or action","OrgController.RegistrationEdit","Registration edit"],["screen element","Questions.cshtml","Org, Registration, Questions"],["page or action","RegSettingController.Update","Update reg setting"],["screen element","SevenDayView.cshtml","Org, Volunteer scheduler, Seven day view"]],"People":[["screen element","Display.cshtml","Person, Profile, Comments, Display"],["screen element","GearStandard.cshtml","Person, Toolbar, Gear standard"],["screen element","Index.cshtml","Attributes"],["screen element","InlineCode.cshtml","Person, Display templates, Inline code"],["screen element","Optouts.cshtml","Person, Communications, Optouts"],["screen element","RegistrationsEdit.cshtml","Person, Enrollment, Registrations edit"]],"Permission checks":[["capability (also relational)","CanCheckInFamily","Check in family"],["capability","CanCreateIntegrationContacts","Create integration contacts"],["capability","CanCreateIntegrationNotes","Create integration notes"],["capability","CanEditPersonDirectoryPrivacy","Edit person directory privacy"],["capability","CanEditPersonProfile","Edit person profile"],["capability","CanEditRegistrationSettings","Edit registration settings"],["capability (also relational)","CanViewDirectoryPersonProfile","View directory person profile"]],"Registrations (API)":[["API endpoint","v1/Involvements/{orgId:int}/Members/{peopleId}/TransactionSummary","Transaction summary (involvements members), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/Settings","Settings (involvements registrations), for a given org"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/Settings/Settings","Settings (involvements registrations settings), for a given org"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/{peopleId:int}/Form","Form (involvements registrations), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/{peopleId:int}/Forms","Forms (involvements registrations), for a given org and people"],["API endpoint","v1/Involvements/{orgId:int}/Registrations/{regId:guid}/Form","Form (involvements registrations), for a given org and reg"],["API endpoint","v1/Involvements/{orgId:int}/TransactionSummary","Transaction summary (involvements), for a given org"]],"Web":[["screen element","Organization.cshtml","Shared, Menu, Organization"],["screen element","User.cshtml","Shared, Menu, User"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_DayOfRegistration.py","Day of registration"],["referenced in script","TPxi_InvolvementSync.py","Involvement sync"],["referenced in script","TPxi_PlacementBoard.py","Placement board"],["referenced in script","TPxi_RollSheet.py","Roll sheet"],["referenced in script","setup_ffmpeg.py","Setup ffmpeg"]]},"EditCampus":{"Permission checks":[["capability (also relational)","CanEditPersonCampus","Edit person campus"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"EmailTemplates":{"Manage":[["page or action","EmailTemplatesController","Email templates controller"]],"Permission checks":[["capability","CanRetrieveSpecialContent","Retrieve special content"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Finance":{"Finance":[["page or action","BundleController","Bundle controller"],["page or action","FinanceReportsController","Finance reports controller"],["page or action","FinanceReportsController.DeleteScheduledGift","Delete scheduled gift"],["page or action","FinanceReportsController.ManagedGiving","Managed giving"],["page or action","FundController","Fund controller"],["page or action","FundController.Index","Index fund"],["page or action","FundSetsController","Fund sets controller"],["page or action","PostBundleController","Post bundle controller"],["page or action","QuickBooksController","Quick books controller"]],"Finance (API)":[["API endpoint","v2/FinanceReports/LapseGiving","Lapse giving (finance reports)"]],"Giving":[["page or action","GivingManagementController.CheckUrlAvailability","Check URL availability"],["page or action","GivingManagementController.Create","Create giving management"],["page or action","GivingManagementController.Delete","Delete giving management"],["page or action","GivingManagementController.GetAvailableFunds","Available funds"],["page or action","GivingManagementController.GetCampusList","Campus list"],["page or action","GivingManagementController.GetConfirmationEmailList","Confirmation email list"],["page or action","GivingManagementController.GetEntryPoints","Entry points"],["page or action","GivingManagementController.GetOnlineNotifyPersonList","Online notify person list"],["page or action","GivingManagementController.GetShellList","Shell list"],["page or action","GivingManagementController.Index","Index giving management"],["page or action","GivingManagementController.List","List giving management"],["page or action","GivingManagementController.Manage","Manage giving management"],["page or action","GivingManagementController.New","New giving management"],["page or action","GivingManagementController.SaveGivingPageEnabled","Save giving page enabled"],["page or action","GivingManagementController.SetGivingDefaultPage","Set giving default page"],["page or action","GivingManagementController.Update","Update giving management"]],"Giving (API)":[["API endpoint","v1/Giving/ContributionFunds","Contribution funds (giving)"]],"Manage":[["page or action","BatchController.RetrieveBatchData","Retrieve batch data"],["page or action","TransactionsController.Adjust","Adjust transactions"],["page or action","TransactionsController.AssignGoer","Assign goer"],["page or action","TransactionsController.CreditVoid","Credit void"],["page or action","TransactionsController.CreditVoidAjax","Credit void ajax"],["page or action","TransactionsController.DeleteGoerSenderAmount","Delete goer sender amount"],["page or action","TransactionsController.DeleteManual","Delete manual"]],"People":[["page or action","PersonController.DeleteDocument","Delete document"],["page or action","PersonController.DeletePledge","Delete pledge"],["page or action","PersonController.EditPledge","Edit pledge"],["page or action","PersonController.FinanceDocuments","Finance documents"],["page or action","PersonController.MemberDocumentUpdateName","Member document update name"],["page or action","PersonController.MergePledge","Merge pledge"],["page or action","PersonController.UploadDocument","Upload document"],["screen element","StatementsWithFund.cshtml","Person, Giving, Statements with fund"]],"Permission checks":[["capability","CanManageContributions","Manage contributions"],["capability","CanManageNonContributions","Manage non contributions"],["capability","CanManageOrViewRecurringOnlineGiving","Manage or view recurring online giving"],["capability","CanRetrieveContributionFunds","Retrieve contribution funds"],["capability","CanRetrieveDataWarehouseList","Retrieve data warehouse list"],["capability","CanUserRunFinanceReports","User run finance reports"]],"Rainforest (API)":[["API endpoint","v1/Rainforest/CleanupMigrationLeftovers","Cleanup migration leftovers (rainforest)"],["API endpoint","v1/Rainforest/DepositReportSession","Deposit report session (rainforest)"],["API endpoint","v1/Rainforest/MerchantOnboardingSession","Merchant onboarding session (rainforest)"],["API endpoint","v1/Rainforest/Merchants","Merchants (rainforest)"],["API endpoint","v1/Rainforest/OnboardingMerchants","Onboarding merchants (rainforest)"],["API endpoint","v1/Rainforest/PayinDetailsSession","Payin details session (rainforest)"],["API endpoint","v1/Rainforest/ProcessMigrationEvents","Process migration events (rainforest)"],["API endpoint","v1/Rainforest/ProcessWebhookEvents","Process webhook events (rainforest)"],["API endpoint","v1/Rainforest/Refund","Refund (rainforest)"]],"Reports":[["page or action","ExportController.Contributions","Contributions export"]],"Setup":[["page or action","LookupController","Lookup controller"]],"Web":[["page or action","Home2Controller.TurnFinanceOff","Turn finance off"],["page or action","Home2Controller.TurnFinanceOn","Turn finance on"],["screen element","User.cshtml","Shared, Menu, User"]],"Your scripts":[["referenced in script","Missions Dashboard.py","Missions dashboard"],["referenced in script","TPxi_AccountSecurityMonitor.py","Account security monitor"],["referenced in script","TPxi_GivingDashboard_backup.py","Giving dashboard backup"],["referenced in script","TPxi_GivingDashboard_broken.py","Giving dashboard broken"],["referenced in script","TPxi_GivingDashboard_broken2.py","Giving dashboard broken2"],["referenced in script","TPxi_InvWithFees.py","Inv with fees"]]},"FinanceAdmin":{"Finance":[["page or action","FinanceReportsController.DeleteScheduledGift","Delete scheduled gift"],["page or action","FinanceReportsController.ManagedGiving","Managed giving"]],"Finance (API)":[["API endpoint","v2/FinanceReports/LapseGiving","Lapse giving (finance reports)"]],"Giving (API)":[["API endpoint","v1/Giving/ContributionFunds","Contribution funds (giving)"]],"Manage":[["page or action","BatchController.RetrieveBatchData","Retrieve batch data"]],"People":[["page or action","PersonController.DeleteDocument","Delete document"],["page or action","PersonController.FinanceDocuments","Finance documents"],["page or action","PersonController.MemberDocumentUpdateName","Member document update name"],["page or action","PersonController.UploadDocument","Upload document"]],"Permission checks":[["capability","CanRetrieveContributionFunds","Retrieve contribution funds"],["capability","CanRetrieveDataWarehouseList","Retrieve data warehouse list"],["capability","CanUserRunFinanceReports","User run finance reports"]],"Rainforest (API)":[["API endpoint","v1/Rainforest/CleanupMigrationLeftovers","Cleanup migration leftovers (rainforest)"],["API endpoint","v1/Rainforest/ProcessMigrationEvents","Process migration events (rainforest)"],["API endpoint","v1/Rainforest/ProcessWebhookEvents","Process webhook events (rainforest)"],["API endpoint","v1/Rainforest/Refund","Refund (rainforest)"]],"Your scripts":[["referenced in script","EnterpriseReporting.py","Enterprise reporting"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_AccountSecurityMonitor.py","Account security monitor"],["referenced in script","TPxi_GoFishDashboard_Enhanced_Full.py","Go fish dashboard enhanced full"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"FinanceDataEntry":{"Finance":[["page or action","BundleController","Bundle controller"],["screen element","Display.cshtml","Bundle, Display"],["screen element","Index.cshtml","Bundle"],["page or action","PostBundleController","Post bundle controller"]],"Rainforest (API)":[["API endpoint","v1/Rainforest/DepositReportSession","Deposit report session (rainforest)"],["API endpoint","v1/Rainforest/Merchants","Merchants (rainforest)"],["API endpoint","v1/Rainforest/PayinDetailsSession","Payin details session (rainforest)"]],"Your scripts":[["referenced in script","EnterpriseReporting.py","Enterprise reporting"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_Dashboards.py","Dashboards"],["referenced in script","TPxi_ReportBuilder.py","Report builder"],["referenced in script","migrate_marketplace_to_rows.py","Migrate marketplace to rows"]]},"FinanceViewOnlyDetail":{"Finance":[["page or action","FinanceReportsController","Finance reports controller"],["page or action","FundController","Fund controller"]],"Giving":[["page or action","GivingManagementController.CheckUrlAvailability","Check URL availability"],["page or action","GivingManagementController.Create","Create giving management"],["page or action","GivingManagementController.Delete","Delete giving management"],["page or action","GivingManagementController.GetAvailableFunds","Available funds"],["page or action","GivingManagementController.GetCampusList","Campus list"],["page or action","GivingManagementController.GetConfirmationEmailList","Confirmation email list"],["page or action","GivingManagementController.GetEntryPoints","Entry points"],["page or action","GivingManagementController.GetOnlineNotifyPersonList","Online notify person list"],["page or action","GivingManagementController.GetShellList","Shell list"],["page or action","GivingManagementController.Index","Index giving management"],["page or action","GivingManagementController.List","List giving management"],["page or action","GivingManagementController.Manage","Manage giving management"],["page or action","GivingManagementController.New","New giving management"],["page or action","GivingManagementController.SaveGivingPageEnabled","Save giving page enabled"],["page or action","GivingManagementController.SetGivingDefaultPage","Set giving default page"],["page or action","GivingManagementController.Update","Update giving management"]],"Permission checks":[["capability","CanViewContributions","View contributions"]],"Reports":[["page or action","ExportController.Contributions","Contributions export"]],"Your scripts":[["referenced in script","EnterpriseReporting.py","Enterprise reporting"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_Dashboards.py","Dashboards"]]},"FundManager":{"Permission checks":[["capability","CanManageOrViewLimitedFunds","Manage or view limited funds"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"IT-Team":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"ManageApplication":{"People":[["screen element","Index.cshtml","Volunteering"],["screen element","Volunteer.cshtml","Person, Ministry, Volunteer"],["page or action","VolunteeringController.Delete","Delete volunteering"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_ComplianceDashboard.py","Compliance dashboard"],["referenced in script","TPxi_Dashboards.py","Dashboards"],["referenced in script","TPxi_FortisTroubleshooter.py","Fortis troubleshooter"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"],["referenced in script","dashboard_phase1_backup.py","Dashboard phase1 backup"]]},"ManageBundles":{"Finance":[["page or action","BundleController.Index","Index bundle"],["page or action","BundlesController","Bundles controller"],["page or action","PostBundleController.FundTotals","Fund totals"],["page or action","PostBundleController.Index","Index post bundle"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"ManageChat":{"Conversations (API)":[["API endpoint","v1/Conversations/Managed","Managed (conversations)"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/BlockedMessages","Blocked messages (conversations managed), for a given conversation"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/Members","Members (conversations managed), for a given conversation"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/Members/{memberId:int}/Add","Add (conversations managed members), for a given conversation and member"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/Members/{memberId:int}/Block","Block (conversations managed members), for a given conversation and member"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/Members/{memberId:int}/Delete","Delete (conversations managed members), for a given conversation and member"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/Members/{memberId:int}/Unblock","Unblock (conversations managed members), for a given conversation and member"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/Messages","Messages (conversations managed), for a given conversation"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/ModerationItems","Moderation items (conversations managed), for a given conversation"],["API endpoint","v1/Conversations/Managed/{conversationId:int}/ReportedMessages","Reported messages (conversations managed), for a given conversation"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"ManageEmails":{"Permission checks":[["capability","CanManageEmailQueue","Manage email queue"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"]]},"ManageGroups":{"Dialog":[["page or action","OrgMemberDialogController.SmallGroupChecked","Small group checked"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"ManageOrgMembers":{"Manage":[["page or action","OrgMembersController","Org members controller"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"ManageResources":{"Manage":[["page or action","MediaController.CreateResource","Create resource"],["page or action","MediaController.CreateResourceCategory","Create resource category"],["page or action","MediaController.CreateResourceType","Create resource type"],["page or action","MediaController.DeleteAttachment","Delete attachment"],["page or action","MediaController.DeleteResource","Delete resource"],["page or action","MediaController.EditResource","Edit resource"],["page or action","MediaController.MoveResource","Move resource"],["page or action","MediaController.MoveResourceCategoryList","Move resource category list"],["page or action","MediaController.SaveAttachmentListOrder","Save attachment list order"],["page or action","MediaController.SaveResourceListOrder","Save resource list order"],["page or action","MediaController.UpdateAttachment","Update attachment"],["page or action","MediaController.UploadAttachment","Upload attachment"],["page or action","ResourceController","Resource controller"]],"Setup":[["page or action","ResourceCategoryController","Resource category controller"],["page or action","ResourceMediaTypeController","Resource media type controller"],["page or action","ResourceTypeController","Resource type controller"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"ManageSMS":{"Main":[["screen element","Announcement.cshtml","Announcement, Announcement"]],"People":[["screen element","MessagesNotificationsLog.cshtml","Person, Communications, Messages notifications log"]],"Permission checks":[["capability","CanSendPushNotification","Send push notification"],["capability","CanStopOrDeleteNotification","Stop or delete notification"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"ManageTransactions":{"Dialog":[["screen element","Tickets.cshtml","Org member dialog, Tabs, Tickets"]],"Manage":[["page or action","BatchController.RetrieveBatchData","Retrieve batch data"],["page or action","TransactionsController","Transactions controller"],["page or action","TransactionsController.Adjust","Adjust transactions"],["page or action","TransactionsController.AssignGoer","Assign goer"],["page or action","TransactionsController.CreditVoid","Credit void"],["page or action","TransactionsController.CreditVoidAjax","Credit void ajax"],["page or action","TransactionsController.DeleteGoerSenderAmount","Delete goer sender amount"],["page or action","TransactionsController.DeleteManual","Delete manual"]],"Permission checks":[["capability","CanManageNonContributions","Manage non contributions"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_MissionsDashboard.py","Missions dashboard"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"Manager":{"Manage":[["page or action","MergeController","Merge controller"]],"Permission checks":[["capability","CanMergePeopleRecords","Merge people records"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","migrate_marketplace_to_rows.py","Migrate marketplace to rows"]]},"Manager2":{"Manage":[["page or action","DuplicatesController","Duplicates controller"],["page or action","MergeController","Merge controller"]],"Permission checks":[["capability","CanMergePeopleRecords","Merge people records"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"MemberDocs":{"People":[["page or action","PersonController.DeleteDocument","Delete document"],["page or action","PersonController.MemberDocumentUpdateName","Member document update name"],["page or action","PersonController.MemberDocuments","Member documents"],["page or action","PersonController.UploadDocument","Upload document"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Membership":{"People":[["page or action","PersonController.DeleteDocument","Delete document"],["page or action","PersonController.MemberDocumentUpdateName","Member document update name"],["page or action","PersonController.MemberDocuments","Member documents"],["page or action","PersonController.UploadDocument","Upload document"]],"Your scripts":[["referenced in script","EnterpriseReporting.py","Enterprise reporting"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_ComplianceDashboard.py","Compliance dashboard"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_ReportBuilder.py","Report builder"],["referenced in script","dashboard_phase1_backup.py","Dashboard phase1 backup"]]},"MissionGiving":{"Org":[["screen element","Reports.cshtml","Org search, Toolbar, Reports"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"MissionsDirector":{"Your scripts":[["referenced in script","Missions Dashboard.py","Missions dashboard"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MissionsDashboard.py","Missions dashboard"]]},"OrgLeadersOnly":{"People":[["screen element","Current.cshtml","Person, Enrollment, Current"],["screen element","Emails.cshtml","Person, Communications, Emails"],["screen element","Members.cshtml","Person, Family, Members"],["screen element","Pending.cshtml","Person, Enrollment, Pending"],["screen element","Previous.cshtml","Person, Enrollment, Previous"],["screen element","Related.cshtml","Person, Family, Related"],["screen element","Tab.cshtml","Person, Enrollment"]],"Permission checks":[["capability (also relational)","CanAddPersonTaskNotes","Add person task notes"],["capability (also relational)","CanTakeAttendance","Take attendance"],["capability (also relational)","CanTakeMeetingAttendance","Take meeting attendance"],["capability (also relational)","CanTakeOrganizationAttendance","Take organization attendance"],["capability (also relational)","CanViewPerson","View person"],["capability (also relational)","CanViewPersonBadges","View person badges"],["capability (also relational)","CanViewPersonChannels","View person channels"],["capability (also relational)","CanViewPersonEmergencyContact","View person emergency contact"],["capability (also relational)","CanViewPersonEngagementScore","View person engagement score"],["capability (also relational)","CanViewPersonInvolvements","View person involvements"],["capability (also relational)","CanViewPersonPrayerRequests","View person prayer requests"],["capability (also relational)","CanViewPersonTaskNotes","View person task notes"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_PhoneDirectory.py","Phone directory"],["referenced in script","TPxi_TPGo.py","TP go"],["referenced in script","TPxi_TouchPointAPIExplorer.py","Touch point API explorer"],["referenced in script","TPxi_TouchPointAPIExplorer_v3.py","Touch point API explorer v3"]]},"OrgTagger":{"Org":[["screen element","Tabs.cshtml","Org search, Tabs"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"PastoralCare":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"ProgramManager":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"ScheduleEmails":{"Main":[["screen element","Announcement.cshtml","Announcement, Announcement"],["screen element","Compose.cshtml","Email, Compose"],["screen element","Index.cshtml","Email"],["screen element","Options.cshtml","SMS, Options"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Security-Doors":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"SendSMS":{"Main":[["screen element","Announcement.cshtml","Announcement, Announcement"]],"People":[["screen element","MessagesNotificationsLog.cshtml","Person, Communications, Messages notifications log"]],"Permission checks":[["capability","CanSendPushNotification","Send push notification"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"SpecialContentBasic":{"Manage":[["page or action","InvolvementController","Involvement controller"]],"Permission checks":[["capability","CanRetrieveSpecialContent","Retrieve special content"]],"Reports":[["page or action","ReportsController.AddReport","Add report"],["page or action","ReportsController.DeleteCustomReport","Delete custom report"],["page or action","ReportsController.EditCustomReport","Edit custom report"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"SpecialContentFull":{"Permission checks":[["capability","CanRetrieveSpecialContent","Retrieve special content"]],"Reports":[["page or action","ReportsController.AddReport","Add report"],["page or action","ReportsController.DeleteCustomReport","Delete custom report"],["page or action","ReportsController.EditCustomReport","Edit custom report"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"SquareReports":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"StatusFlag":{"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_EngagementIndex.py","Engagement index"],["referenced in script","TPxi_MenuEditor.py","Menu editor"]]},"SuperAdmin":{"Your scripts":[["referenced in script","Missions Dashboard.py","Missions dashboard"],["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_MenuEditor.py","Menu editor"],["referenced in script","TPxi_MissionsDashboard.py","Missions dashboard"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"],["referenced in script","TPxi_RegistrationDataManager.py","Registration data manager"]]},"TicketScanning":{"Permission checks":[["capability","CanScanTickets","Scan tickets"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"Ticketing":{"Dialog":[["screen element","Tickets.cshtml","Org member dialog, Tabs, Tickets"]],"People (API)":[["API endpoint","v1/People/Search/AutocompleteEx/Registration","Registration (people search autocomplete ex)"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"UploadPeople":{"Manage":[["page or action","UploadPeopleController","Upload people controller"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]},"ViewApplication":{"People":[["screen element","Volunteer.cshtml","Person, Ministry, Volunteer"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"],["referenced in script","TPxi_QuickLinksAdmin.py","Quick links admin"]]},"ViewTransactions":{"Permission checks":[["capability","CanViewNonContributions","View non contributions"]],"Your scripts":[["referenced in script","TPxi_AccessAudit.py","Access audit"]]}}"""
